...
function img_check(a, b, c) {
    ...
    this.AllowExt = ".jpg,.gif,.jpeg,.png,.pjpeg", this.FileExt = a.val().substr(a.val().lastIndexOf(".")).toLowerCase(), 0 != this.AllowExt && -1 == this.AllowExt.indexOf(this.FileExt) ? errorTips("只支持jpg、gif、png、jpeg格式，请重新上传", "上传头像") : ($("#" + c + "_error").text("").hide(), $.ajaxFileUpload({
        ...
        secureuri: !1,
        fileElementId: c,
        data: {headPic: a.val(),rid:$("#resumeId").val()},
        dataType: "Text",
        success: function (a) {
            if (JSON.parse(a).success) {
                var a = JSON.parse(a);
                var b = a.content;
                $("#portraitShow img").attr("src", "/" + b), $("#basicInfo .basicShow .m_portrait img").attr("src", "/" + b), $("#portraitNo").hide(), $("#portraitShow").show()
...
!function (a, b) {
    ...
    window.onbeforeunload = function () {
        ...
        $(this).validate({
            ...
            messages: {
                companyName: {required: "请输入有效的公司名称，如：阿里巴巴", maxlenStr: "请输入有效的公司名称，如：阿里巴巴"},
                positionName: {
