    ...
    0 != this.AllowExt && -1 == this.AllowExt.indexOf(this.FileExt) ? errorTips("只支持jpg、gif、png、jpeg格式，请重新上传", "上传头像") : ($("#" + c + "_error").text("").hide(), $.ajaxFileUpload({
        ...
        success: function(a) {
            if (JSON.parse(a).success) {
                ...
                $("#basicInfo .basicShow .m_portrait img").attr("src", "/" + b),
                $("#portraitNo").hide(),
                $("#portraitShow").show()
            } else errorTips("上传失败，请重新上传", "上传头像")
        },
        error: function() {
            errorTips("上传失败，请重新上传11", "上传头像")
        }
    }))
}
...
function file_check(obj, action_url, id) {
    ...
    0 != this.AllowExt && -1 == this.AllowExt.indexOf(this.FileExt) ? (errorTips("只支持word、pdf、ppt、txt、wps格式文件，请重新上传"), $("#loadingImg").css("visibility", "hidden")) : $.ajaxFileUpload({
        ...
        success: function(data) {
            ...
            data.success ? (html = '<a href="/'+data.content.url+'" class="resume_download" title="下载' + data.content.nearbyName + '">' + data.content.nearbyName + "</a>" + '<a  class="fr del" href="javascript:;">删除</a><br /><span class="c9">上传时间：' + data.content.time + "</span>", $("#myResume .resumeUploadDiv").html(html), $("#myResume h2 a").html("重新上传"), $.colorbox({
                inline: !0,
                href: $("div#uploadFileSuccess"),
                title: "上传附件简历"
            })) : -1 == data.code ? $.colorbox({
                inline: !0,
                href: $("div#fileResumeUpload"),
                title: "附件简历上传失败"
            }) : -2 == data.code ? $.colorbox({
                inline: !0,
...
$(function() {
        ...
        $(".projectForm").each(function() {
            $(this).validate({
                ...
                submitHandler: function(a) {
                    ...
                    $.ajax({
                        url: "/user/projectexperience.html",
                        type: "POST",
                        data: {
                            projectName: b,
                            positionName: c,
                        ...
                        window.location.href='/user/myresume.html';
                        //var c, e;
    ...
    $("#resumeNameForm").validate({
        ...
        submitHandler: function(a) {
            ...
            $.ajax({
                ...
                if (b.success) {
                    var c = "";
                    $("#resume_name .nameShow .rename").text('重命名')
    ...
    $("#profileForm").validate({
        ...
        messages: {
            ...
            email: {
                ...
                email: "请输入有效的常用邮箱，如：vivi@xyz.com",
                maxlength: "请输入有效的常用邮箱，如：vivi@xyz.com"
            },
            tel: {
                required: "请输入手机号码",
                isMobile: "请输入有效的手机号码",
    ...
    c = {
        ...
        Del: function(a) {
            ...
            $.ajax({
                url: "/user/workExperiencedel.html",
                type: "POST",
                data: {
                    id: b
                }
    ...
    $(".experienceForm").each(function() {
        $(this).validate({
            ...
            messages: {
                companyName: {
                    required: "请输入有效的公司名称，如：阿里巴巴",
                    maxlenStr: "请输入有效的公司名称，如：阿里巴巴"
                },
                positionName: {
            ...
            submitHandler: function(a) {
                ...
                $.ajax({
                    ...
                    //     e += '<i class="sm_del dn"></i><i class="sm_edit dn"></i><span class="c9" data-startYear="' + d[f].startYear + '" data-endYear="' + d[f].endYear + '" data-startMonth = "' + d[f].startMonth + '" data-endMonth = "' + d[f].endMonth + '">' + d[f].startDate + "-" + d[f].endDate + "</span>" + "<div>" + '<img src="' + "/" + d[f].companyLogo + '" width="56" height="56" alt="' + d[f].companyName + '" />' + "<h3>" + d[f].positionName + "</h3>" + "<h4>" + d[f].companyName + "</h4>" + "</div>" + "</li>";
    ...
    d = {
        ...
        Del: function(a) {
            ...
            $.ajax({
                url: "/user/projectexperiencedeldel.html",
                type: "POST",
                data: {
                    id: b
                }
    ...
    f = {
        ...
        AddMore: function() {
            ...
            this.obj.children(".educationalEdit").find(".schoolYearEnd").val(""),
            this.obj.children(".educationalEdit").find(".select_schoolYearEnd").css("color", "#999").val("结束年份"),
            this.obj.children(".educationalEdit").find(".eduId").val(""),
            placeholderFn(),
            this.obj.children(".educationalEdit").show(),
            this.obj.find(".educationalForm ").show(),
            j(this.obj)
        },
        Edit: function(a) {
            var b = a.parent("li").attr("data-id"),
            ...
            this.obj.children(".educationalEdit").find(".schoolName").val(g),
            this.obj.children(".educationalEdit").find(".degree").val(e),
            this.obj.children(".educationalEdit").find(".select_degree").css("color", "#333").val(e),
            this.obj.children(".educationalEdit").find(".professionalName").val(f),
            this.obj.children(".educationalEdit").find(".schoolYearStart").val(c),
            this.obj.children(".educationalEdit").find(".select_schoolYearStart").css("color", "#333").val(c),
            this.obj.children(".educationalEdit").find(".schoolYearEnd").val(d),
            this.obj.children(".educationalEdit").find(".select_schoolYearEnd").css("color", "#333").val(d),
            this.obj.children(".educationalEdit").find(".eduId").val(b),
        ...
        Del: function(a) {
            var b = a.parent("li").attr("data-id");
            $.ajax({
                url: "/user/educationalexperiencedel.html",
                type: "POST",
                dataType: 'json',
                data: {
                    id: b
        ...
        AddCancel: function() {
            ...
            this.obj.find(".educationalForm ").hide(),
    ...
    $(".educationalForm").each(function() {
        $(this).validate({
            ...
            submitHandler: function(a) {
                ...
                $(a).find(":submit").val("保存中...").attr("disabled", !0),
                $.ajax({
                    url: "/user/educationalexperience.html",
                    type: "POST",
                    data: {
                        schoolName: b,
                        education: c,
