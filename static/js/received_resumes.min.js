...
function suggestEmail(a) {
    ...
    $.ajax({
        type: "GET",
        async: !1,
        url: "/corpResume/forwardEmails.json",
        dataType: "json"
    }).done(function(a) {
        b = a.content
    }),
...
$(function() {
    ...
    function() {
        ...
        return confirm("确定要删除该简历吗？") ? ($.ajax({
            type: "POST",
            url: "/recruitment/resume-del.html",
            data: {
                deliverIds: b
            },
            dataType: "json"
    ...
    function() {
        ...
        0 == a.length ? (alert("请选择要删除的简历"), !1) : confirm("确定要删除选中的简历吗？") ? ($.ajax({
            type: "POST",
            url: "/recruitment/resume-del-all.html",
            data: {
                deliverIds: a
            },
            dataType: "json"
    ...
    function() {
        ...
        $.ajax({
            url: "/recruitment/not_suitable_resume.html",
            dataType: "json",
            type: "POST",
            async: !1,
            data: {
    ...
    $("#refuseMailForm").validate({
        ...
        submitHandler: function(a) {
            ...
            var c = $('input[name="deliverId"]', a).val();
            $.ajax({
                url: "/recruitment/send-mail.html",
                type: "POST",
                data: {
                    content: b,
                    deliverIds: c
    ...
    $("#resumeRefuseAll").click(function() {
        ...
        "" == a ? (alert("请选择要标记的简历"), !1) : confirm("确定要标记选中的简历为不合适简历吗？确认后系统将自动发送拒绝信至用户邮箱") ? ($.ajax({
            type: "POST",
            url: "/recruitment/not_suitable_resume-all.html",
            data: {
                deliverIds: a
            },
            dataType: "json"
    ...
    $(".resume_caninterview").click(function() {
        ...
        $.ajax({
            type: "POST",
            url: "/corpResume/markInterview.json",
            data: {
                deliverIds: a
            },
            dataType: "json"
    ...
    $("#resumeInterviewAll").click(function() {
        ...
        "" == a ? (alert("请选择要标记的简历"), !1) : confirm("确定要标记选中的简历为待定简历吗？") ? ($.ajax({
            type: "POST",
            url: "/recruitment/indefinite-resume.html",
            data: {
                deliverIds: a
            },
            dataType: "json"
    ...
    $("#forwardResumeForm").validate({
        ...
        submitHandler: function(a) {
            ...
            var c = $('input[name="title"]', a).val();
            var d = $('textarea[name="content"]', a).val();
            var e = $('input[name="resumeKey"]', a).val();
            var f = $('input[name="deliverId"]', a).val();
            var g = $('input[name="positionId"]', a).val();
            $.ajax({
                type: "POST",
                url: "/corpResume/forward.json",
                data: {
                    recipients: b,
                    title: c,
                    content: d,
    ...
    function() {
        ...
        $.ajax({
            type: "POST",
            url: "/recruitment/interview.html",
            data: {
                email: a,
                positionId: b,
                name: c
    ...
    $("#noticeInterviewForm").validate({
        ...
        submitHandler: function(a) {
            ...
            var d = $('input[name="subject"]', a).val();
            var e = $('input[name="interTime"]', a).val();
            var f = $('input[name="interAdd"]', a).val();
            var g = $('input[name="linkMan"]', a).val();
            var h = $('input[name="linkPhone"]', a).val();
            var i = $('textarea[name="content"]', a).val();
            var j = $('input[name="positionName"]', a).val();
            var k = $('input[name="companyName"]', a).val();
            var l = $('input[name="deliverId"]', a).val();
            $.ajax({
                type: "POST",
                data: {
                    name: b,
                ...
                url: "/recruitment/send_inter_mail.html",
                dataType: "json"
            }).done(function(a) {
                a.success ? $.colorbox({
                    inline: !0,
    ...
    function() {
        ...
        var b = $('#noticeInterviewForm input[name="email"]').val();
        var c = $('#noticeInterviewForm input[name="subject"]').val();
        var d = $('#noticeInterviewForm input[name="interTime"]').val();
        var e = $('#noticeInterviewForm input[name="interAdd"]').val();
        var f = $('#noticeInterviewForm input[name="linkMan"]').val();
        var g = $('#noticeInterviewForm input[name="linkPhone"]').val();
        var h = $('#noticeInterviewForm textarea[name="content"]').val();
        h = h.replace("/\r\n/g", "<br>");
