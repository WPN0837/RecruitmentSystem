...
function product_check(a, b, c, d, e, f) {
    ...
    0 != this.AllowExt && -1 == this.AllowExt.indexOf(this.FileExt) ? errorTips("只支持jpg、jpeg、gif、png格式，请重新上传") : $.ajaxFileUpload({
        ...
        dataType: "text",
        success: function(a) {
            "" != a ? ($("." + f, g).val(a), $("." + d + " img", g).attr("src", "/" + a), $("." + c, g).hide(), $("." + d, g).show()) : $(".errorTips").click(function() {
...
$(function() {
    ...
    $("#saveLabels").click(function() {
        ...
        $.ajax({
            ...
            url: "/companyLabel/pasteLabelToCompany.json"
        }).done(function(b) {
        ...
        $(this).validate({
            ...
            submitHandler: function(a) {
                ...
                $.ajax({
                    ...
                    b.success ? ($(".member_info:nth-child(1)", i).addClass("dn"), $(".member_info:nth-child(2)", i).addClass("dn"), $(".member_info:nth-child(2) .leader_id", i).val(b.content.id), $(".member_info:nth-child(3) img", i).attr("src", "/" + b.content.photo), "" != b.content.weibo ? $(".member_info:nth-child(3) .m_name", i).html(b.content.name + '<a href="' + b.content.weibo + '" class="weibo" target="_blank"></a>') : $(".member_info:nth-child(3) .m_name", i).html(b.content.name), $(".member_info:nth-child(3) .m_position", i).html(b.content.position), $(".member_info:nth-child(3) .m_intro", i).html(b.content.remark), $(".member_info:nth-child(3)", i).removeClass("dn"), $("#Member .member_wrap").length >= 3 ? $("#Member .c_add").hide() : $("#Member .c_add").show()) : 1 == $(".member_wrap").length ? ($(".member_info:nth-child(1)", i).removeClass("dn"), $(".member_info:nth-child(2)", i).addClass("dn"), $(".member_info:nth-child(2) input[type!='submit'], .member_info:nth-child(2) textarea", i).val(""), $(".member_info:nth-child(3)", i).addClass("dn"), $("#Member .c_add").hide()) : ($(i).remove(), $("#Member .c_add").show()),
    ...
    function() {
        ...
        $(".productForm", a).validate({
            ...
            submitHandler: function(b) {
                ...
                $.ajax({
                    type: "POST",
                    url: "/cp/saveCompanyProduct.json",
                    data: {
                        companyId: c,
                        id: d,
                        type: 1,
        ...
        $(this).validate({
            ...
            submitHandler: function(a) {
                ...
                $.ajax({
                    ...
                    $("#resubmitToken").val(b.resubmitToken),
                    b.success ? ($("dl:nth-child(1)", i).addClass("dn"), $("dl:nth-child(2)", i).addClass("dn"), $("dl:nth-child(2) .product_id", i).val(b.content.id), $("dl:nth-child(3) img", i).attr("src", "/" + b.content.productPicUrl), $("dl:nth-child(3) .cp_intro a", i).attr("href", b.content.productUrl), $("dl:nth-child(3) .cp_intro a", i).html(b.content.product), $("dl:nth-child(3) .jspPane > div", i).html(b.content.productProfile), $("dl:nth-child(2) textarea", i).text(b.content.productProfile), $("dl:nth-child(3)", i).removeClass("dn"), $(".scroll-pane").jScrollPane()) : 1 == $(".product_wrap").length ? ($("dl:nth-child(1)", i).removeClass("dn"), $("dl:nth-child(2)", i).addClass("dn"), $("dl:nth-child(2) input[type!='submit'], dl:nth-child(2) textarea", i).val(""), $("dl:nth-child(2) textarea", i).text(""), $("dl:nth-child(3)", i).addClass("dn")) : $(i).remove(),
                    $(a).find(":submit").attr("disabled", !1)
                })
            }
        })
    ...
    $("#editDetailForm").validate({
        ...
        submitHandler: function(a) {
            ...
            $.ajax({
                type: "POST",
                url: "/cd/saveProfileShortNameAndFeatures.json",
                data: {
                    companyId: b,
                    companyShortName: d,
                    companyFeatures: c
    ...
    $("#tagForms").validate({
        ...
        submitHandler: function(a) {
            ...
            $.ajax({
                type: "POST",
                url: "/cd/saveProfileBaseInfo.json",
                data: {
                    companyId: b,
                    city: c,
                    industryField: d,
