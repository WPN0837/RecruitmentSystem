...
function img_check(a, b, c, d) {
    ...
    0 != this.AllowExt && -1 == this.AllowExt.indexOf(this.FileExt) ? $("#" + c + "_error").text("只支持jpg、gif、png、jpeg格式，请重新上传").show() : ($("#" + c + "_error").text("").hide(), $.ajaxFileUpload({
        ...
        dataType: "text",
        success: function(a) {
            "" != a ? ($("#logoShow img").attr("src", "/" + a), $("#logoNo").hide(), $("#logoShow").show(), $("#logo").val(a)) : $("#" + c + "_error").text("上传失败，请重新上传").show()
        },
        error: function() {
...
$(function() {
    ...
    //null == $.cookie("viewTimes") ? ($("#stepTip img").attr("src", "/static/images/tiponce.jpg").parent("#stepTip").fadeIn(200), $.cookie("viewTimes", "1", b)) : (c = parseInt($.cookie("viewTimes")) + 1, $("#stepTip img").attr("src", "/static/images/tipagain.jpg").parent("#stepTip").fadeIn(200), $.cookie("viewTimes", c, b)),
    $('#box_industry').click(function() {
        var a = [];
    ...
    $("#stepForm").validate({
        ...
        submitHandler: function(b) {
            ...
            $.ajax({
                ...
                url: "/recruitment/company-info.html"
            }).done(function(a) {
                a.success ? window.location.href = "/recruitment/company-tags.html": $("#beError").text(a.msg).show(),
